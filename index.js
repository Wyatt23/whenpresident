...
app.get("/login/twitter", function(req, res){
  var url = "https://api.twitter.com/oath/request_token";
  var oauth = {
    callback:        process.env.t_callback_url,
    consumer_key:    process.env.t_consumer_key,
    consumer_secret: process.env.t_constumer_secret,
  }
  request.post({url: url, oauth: oauth},function(e,response){
    ...
    req.session.t_oath_token        = auth_data.oauth_token;
    req.session.t_oath_token_secret = auth_data.oauth_token_secret;
